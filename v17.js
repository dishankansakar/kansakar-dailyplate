...
const V17_VERSION='1.7',V17_KJ_PER_KCAL=4.184;
...
function v17Init(){document.title='Daily Plate v1.7';v17Migrate();document.querySelectorAll('.fav-btn').forEach(x=>x.remove());if(STATE.profile){renderHome();renderToday();renderIngredientLibrary();renderProfileScreen();renderLog()}}
